    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medals', models.ManyToManyField(blank=True, to='main.Medal')),
            ],
        ),
        migrations.CreateModel(
            name='Show',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('breed', models.CharField(choices=[('b', 'bulldog'), ('p', 'poodle'), ('r', 'retriever')], max_length=1)),
                ('experts', models.ManyToManyField(blank=True, related_name='ring_experts', to='main.Expert')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=main.models.get_upload_path, validators=[main.validators.validate_file_size, main.validators.validate_file_type])),
                ('file_name', models.CharField(blank=True, max_length=100, null=True)),
                ('file_size', models.IntegerField(blank=True, null=True)),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participant_photos', to='main.participant')),
            ],
        ),
        migrations.AddField(
            model_name='participant',
            name='rings',
            field=models.ManyToManyField(blank=True, to='main.Ring'),
        ),
        migrations.CreateModel(
            name='Grade',
            fields=[
